...
def generate_launch_description():
    ...
    # moveit_config.planning_pipelines["ompl"]["panda_arm"]["enforce_joint_model_state_space"] = True
    ...
    moveit_config.planning_pipelines["ompl"]["planner_configs"]["RRTstarkConfigDefault"]["optimization_objective"] = "CostConvergence[10,0.1]"
